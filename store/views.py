...
from .models import Cart, CartItem, Customer, Collection, Product, Review, Order, OrderItem, ProductImage
from .serializers import CartItemSerializer, CartSerializer,CustomerSerializer, CollectionSerializer,\
                         ProductSerializer, ReviewSerializer, AddCartItemSerializer,\
